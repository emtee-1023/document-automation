...
<script type="module">
    ...
    navigator.serviceWorker.register(' https://c491-41-215-139-96.ngrok-free.app/law/firebase-messaging-sw.js', {
            scope: '/law/' // This is critical: it ensures the service worker operates within the /law/ directory.
        })
