...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .dropdown-menu-sm-center {
                ...
                min-width: 200px; /* Adjust the minimum width if necessary */
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index">E-Drafting</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-5 me-lg-5">
                ...
                $isread = 0;
                $sql = "SELECT NotifID FROM notifications WHERE IsRead = ? AND clientid = ? AND (SendAt <= NOW() OR SendAt IS NULL)";
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-sm-center" aria-labelledby="notificationsDropdown">
                        ...
                        $user = $_SESSION['userid'];
                        $is_read = 0;
                        $sql = "SELECT NotifID, NotifSubject, NotifText FROM notifications WHERE ClientID = ? AND IsRead = ? AND (SendAt <= NOW() OR SendAt IS NULL)";
                        $stmt = mysqli_prepare($conn, $sql);
